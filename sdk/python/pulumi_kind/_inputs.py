...
class ClusterKindConfigNodeExtraMountArgs:
    def __init__(__self__, *,
                 ...
                 selinux_relabel: Optional[pulumi.Input[bool]] = None):
    ...
    def selinux_relabel(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "selinux_relabel")

    @selinux_relabel.setter
    def selinux_relabel(self, value: Optional[pulumi.Input[bool]]):
