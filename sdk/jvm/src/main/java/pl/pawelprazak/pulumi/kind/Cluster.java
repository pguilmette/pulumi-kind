...
package pl.pguilmette.pulumi.kind;
...
import pl.pguilmette.pulumi.kind.inputs.*;
...
public class Cluster extends io.pulumi.resources.CustomResource {
    ...
    @OutputExport(name="kindConfig", type=pl.pguilmette.pulumi.kind.outputs.ClusterKindConfig.class, parameters={})
    private Output</* @Nullable */ pl.pguilmette.pulumi.kind.outputs.ClusterKindConfig> kindConfig;

    public Output</* @Nullable */ pl.pguilmette.pulumi.kind.outputs.ClusterKindConfig> getKindConfig() {
