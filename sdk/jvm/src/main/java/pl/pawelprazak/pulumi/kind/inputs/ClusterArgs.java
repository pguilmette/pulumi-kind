...
public final class ClusterArgs extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigArgs> kindConfig;

    public Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigArgs> getKindConfig() {
    ...
    public ClusterArgs(
        @Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigArgs> kindConfig,
    ...
    public static final class Builder {
        private @Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigArgs> kindConfig;
        ...
        public Builder setKindConfig(@Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigArgs> kindConfig) {
            this.kindConfig = kindConfig;
            return this;
        }

        public Builder setKindConfig(@Nullable pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigArgs kindConfig) {
