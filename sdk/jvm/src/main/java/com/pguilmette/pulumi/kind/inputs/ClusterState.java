...
public final class ClusterState extends io.pulumi.resources.ResourceArgs {
    ...
    private final @Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigGetArgs> kindConfig;

    public Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigGetArgs> getKindConfig() {
    ...
    public ClusterState(
        ...
        @Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigGetArgs> kindConfig,
    ...
    public static final class Builder {
        ...
        private @Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigGetArgs> kindConfig;
        ...
        public Builder setKindConfig(@Nullable Input<pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigGetArgs> kindConfig) {
            this.kindConfig = kindConfig;
            return this;
        }

        public Builder setKindConfig(@Nullable pl.pguilmette.pulumi.kind.inputs.ClusterKindConfigGetArgs kindConfig) {
